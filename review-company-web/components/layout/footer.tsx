        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-600 text-sm max-w-md leading-relaxed mb-6">
              Nền tảng đánh giá công ty hàng đầu Việt Nam. Giúp bạn tìm hiểu môi
              trường làm việc, văn hóa công ty và cơ hội phát triển trước khi
              quyết định.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              {/* <li>
                <a href="tel:" className={footerLinkClass}>

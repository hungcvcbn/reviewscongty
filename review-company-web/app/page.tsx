...
import { Building2, Star, MessageSquare, TrendingUp, Users, Sparkles, ArrowRight, CheckCircle2 } from 'lucide-react';
...
import { FadeIn, AnimatedCounter, StaggeredList, ScrollToTop } from '@/components/animations';
    ...
    <div className="flex flex-col overflow-hidden">
      ...
      <section className="relative bg-gradient-to-br from-blue-50 via-white to-indigo-50 py-24 px-4 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-indigo-200/30 rounded-full blur-3xl animate-pulse-soft" style={{ animationDelay: '1s' }} />
        ...
        <div className="container mx-auto max-w-5xl text-center relative z-10">
          ...
          <FadeIn direction="up" delay={200}>
            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
              Đọc review từ nhân viên thực tế về môi trường làm việc, 
              văn hóa công ty và cơ hội phát triển.
            </p>
          </FadeIn>
            ...
            >
                ...
                <CardContent className="flex items-center gap-4 p-6">
                  ...
                  <div>
                    <p className="text-3xl font-bold text-gray-900">
                      <AnimatedCounter end={stats.totalCompanies} duration={2000} suffix="+" />
                    </p>
              ...
              <Card className={cn(
                ...
                <CardContent className="flex items-center gap-4 p-6">
                  ...
                  <div>
                    <p className="text-3xl font-bold text-gray-900">
                      <AnimatedCounter end={stats.totalReviews} duration={2000} suffix="+" />
                    </p>
              ...
              <Card className={cn(
                ...
                <CardContent className="flex items-center gap-4 p-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 font-medium">Rating trung bình</p>
                  </div>
                </CardContent>
              </Card>
            </StaggeredList>
        ...
        <div className="container mx-auto max-w-6xl">
          <FadeIn>
            <div className="text-center mb-12">
              ...
              <p className="text-gray-500 max-w-2xl mx-auto">
                Chúng tôi cung cấp thông tin minh bạch và đáng tin cậy để giúp bạn đưa ra quyết định nghề nghiệp tốt nhất.
              </p>
            </div>
          </FadeIn>
          ...
          >
            <div className={cn(
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Review thực tế</h3>
            ...
            <div className={cn(
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Đánh giá chi tiết</h3>
              <p className="text-gray-600">
                Đánh giá theo nhiều tiêu chí: lương, văn hóa, môi trường làm việc.
              </p>
            </div>
            ...
            <div className={cn(
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Thông tin công ty</h3>
              <p className="text-gray-600">
          ...
          <FadeIn>
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-blue-100 text-lg mb-10 leading-relaxed">
                ...
                Review của bạn có thể thay đổi cuộc sống của ai đó!
              </p>
              <Link href="/companies">
                <Button 
                  size="lg" 
